 ...
 */
final class Version20200223044926 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte CHANGE date_creation date_creation DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte CHANGE date_creation date_creation DATE NOT NULL');
