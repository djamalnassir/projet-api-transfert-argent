 ...
 */
final class Version20200228225419 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image LONGBLOB DEFAULT NULL, ADD nom VARCHAR(255) DEFAULT NULL, DROP image_id, CHANGE partenaire_id partenaire_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image_id INT DEFAULT NULL, DROP image, DROP nom, CHANGE partenaire_id partenaire_id INT DEFAULT NULL');
